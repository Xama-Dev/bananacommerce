...
import { onMouseOvermenuAside } from './onMouseOverMenuAside'
import NavbarMobile from './navbarComponents/navbarMobile/NavbarMobile'
import MenuDepartamentsMobile from './navbarComponents/menuDepartamentsMobile/MenuDepartmentsMobile'
                            ...
                            <div id="wrap-dropdown-li-shop">
                                ...
                                <div className="container-dropdown ">                            
                                    <ul>
                                        ...
                                        <li><a href="/">Shop without banner</a></li>
                                        <li><a href="/">Shop carrousel</a></li>
                                        <li><a href="/">Category layout 1</a></li>
                                        <li><a href="/">Products of category</a></li>
                                    </ul> 
                                    <ul>
                                        ...
                                        <li><a href="/">Sidbar</a></li>                                    
                                    </ul>
                                    <ul>
                                        <span>Product Types</span>
                                        <li><a href="/">Simple</a></li>
                                        <li><a href="/">Color Swatches</a></li>
                                        <li><a href="/">Image Swatches</a></li>
                                        <li><a href="/">Coundown</a></li>
                                        <li><a href="/">360 Degree</a></li>
                                        <li><a href="/">Multi-Vendor</a></li>
                                        <li><a href="/">Instagram</a></li>
                                        <li><a href="/">Affiliate</a></li>
                                        <li><a href="/">Item</a></li>
                                        <li><a href="/">On Sale</a></li>
                                        <li><a href="/">Video Featured</a></li>
                                        <li><a href="/">Groupped</a></li>
                            ...
                            <div id="wrap-dropdown-li-blog">
                                ...
                                <div className="container-dropdown ">
                                    <ul>
                                        ...
                                        <li><a href="/">Small Thumb</a></li>
                                        <li><a href="/">Left Sidebar</a></li>
                                        <li><a href="/">Right Sidebar</a></li>                                    
                                    </ul> 
                                    <ul>
                                        <span>Single Blog</span>
                                        <li><a href="/">Single Blog v1</a></li>
                                        <li><a href="/">Single Blog v2</a></li>
                                        <li><a href="/">Single Blog v3</a></li>
                                        <li><a href="/">Single Blog v4</a></li>                                                                       
                                    </ul>                           
                                </div>
                            </div>
                        </div>
